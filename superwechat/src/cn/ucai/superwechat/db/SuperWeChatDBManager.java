...
public class SuperWeChatDBManager {
    ...
    public synchronized Integer saveMessage(InviteMessage message){
        ...
        if(db.isOpen()){
            ...
            values.put(InviteMessgeDao.COLUMN_NAME_NICK_NAME, message.getUserNick());
            values.put(InviteMessgeDao.COLUMN_NAME_AVATAR_SUFFIX, message.getAvatarSuffix());
            values.put(InviteMessgeDao.COLUMN_NAME_AVATAR_TIME, message.getAvatarLastUpdateTime());
    ...
    synchronized public List<InviteMessage> getMessagesList(){
        ...
        if(db.isOpen()){
            ...
            while(cursor.moveToNext()){
                ...
                String userNick= cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_NICK_NAME));
                String avatarSuffix = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_AVATAR_SUFFIX));
                String lastUpdateTime = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_AVATAR_TIME));
                ...
                msg.setAvatarLastUpdateTime(lastUpdateTime);
