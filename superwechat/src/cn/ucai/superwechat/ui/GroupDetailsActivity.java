...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	private void exitGrop() {
		...
		NetDao.removeGroupMember(getContext(), groupId, EMClient.getInstance().getCurrentUser(), new OnCompleteListener<String>() {
			@Override
			public void onSuccess(String s) {
				Log.e(TAG, "exitGrop: s="+s );
			}
				...
				button.setOnClickListener(new OnClickListener() {
					...
					protected void deleteMembersFromGroup(final String username) {
						...
						NetDao.removeGroupMember(getContext(), groupId, username, new OnCompleteListener<String>() {
							@Override
							public void onSuccess(String s) {
								Log.e(TAG, "deleteMemberFromGroup: s="+s );
							}
